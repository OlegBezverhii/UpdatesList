        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                foreach (ManagementObject share in searcher.Get())
                {
                    ...
                    Console.WriteLine("{0,-20} {1}","Обновление: ", share["HotFixID"]);// String
                    Console.WriteLine("{0,-20} {1}", "Тип обновления: ", share["Description"]);
                    Console.WriteLine("{0,-20} {1}", "Ссылка/описание: ", share["Caption"]);
                    Console.WriteLine("{0,-20} {1}", "Дата установки: ", share["InstalledOn"]);
                    Console.WriteLine("");

                    sw.WriteLine("{0,-20} {1}", "Обновление: ", share["HotFixID"]);
                    sw.WriteLine("{0,-20} {1}", "Тип обновления: ", share["Description"]);
                    sw.WriteLine("{0,-20} {1}", "Ссылка/описание: ", share["Caption"]);
                    sw.WriteLine("{0,-20} {1}", "Дата установки: ", share["InstalledOn"]);
                    sw.WriteLine();
